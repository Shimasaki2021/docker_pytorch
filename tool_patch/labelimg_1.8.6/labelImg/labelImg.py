...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def set_zoom(self, value):
        ...
        self.zoom_widget.setValue(int(value)) # bugfix 2024.12.28
    ...
    def zoom_request(self, delta):
        ...
        h_bar.setValue(int(new_h_bar_value)) # bugfix 2024.12.28
        v_bar.setValue(int(new_v_bar_value)) # bugfix 2024.12.28
